...
public class Video {
		...
		public String toString() {
			return "Video [videoName=" + videoName + ", videoType=" + videoType + ", videoYear=" + videoYear
					...
					+ ", videoPath=" + videoPath + ", adminId=" + adminId + ", uploadDate=" + uploadDate
					+ ", VideoReview=" + VideoReview + ", domainId=" + domainId + ", homeTopStatus=" + homeTopStatus
					+ ", Introduction=" + Introduction + ", videoId=" + videoId + ", views=" + views + ", save=" + save
					+ ", picture=" + Arrays.toString(picture) + ", type=" + type + ", videoStartYear=" + videoStartYear
					+ ", videoEndYear=" + videoEndYear + ", memberId=" + memberId + "]";
		}
