...
@WebServlet("/selectAttractionTimeByVideoId")
public class selectAttractionTimeByVideoId extends HttpServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		String attTime = vps.selectAttractionTimeByVideoId(id);
		
		resp.setContentType("application/json");
		resp.getWriter().write(attTime);
	}
