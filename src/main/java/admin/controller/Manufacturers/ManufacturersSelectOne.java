...
@WebServlet("/manufacturersSelectOne")
public class ManufacturersSelectOne extends HttpServlet {
	private ManufacturersService ms;

	public ManufacturersSelectOne() {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		String ress = ms.selectOne(requestBody);
