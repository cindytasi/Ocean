...
@WebServlet("/userNosubscribeCount")
public class UserNosubscribeCount extends HttpServlet{
	private UserService service;
	
	
	public UserNosubscribeCount() {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		Integer count = service.selectNosubscribeCount();
